...
public class FilaPedidoDAO {
    ...
    public boolean listarFilaPedido() {
        ...
        try {
            ...
            String SQL = "select fp.id_fila_pedido, pe.nm_nome Mesa, m.nm_nome cliente, ca.nm_item_cardapio Item, fp.ds_status Status, pe.nm_nome empredado\n"
                    + "from tb_fila_pedido fp, tb_pedido_cardapio pc, tb_empregado em, tb_pedido p, tb_mesa m, tb_cliente c, tb_pessoa pe, tb_cardapio ca\n"
                    ...
                    + "and em.id_pessoa = pe.id_pessoas";
